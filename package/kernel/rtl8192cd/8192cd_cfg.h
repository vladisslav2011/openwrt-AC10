...
//vlad
#include <bspchip.h>
void rtl819x_gpio_pin_set_val(unsigned int pin, int val);

#define DBG_LED_WIFI(x) rtl819x_gpio_pin_set_val(BSP_GPIO_PIN_E1,(x)?0:1)
#define DBG_LED_LAN(x)  rtl819x_gpio_pin_set_val(BSP_GPIO_PIN_D7,(x)?1:0)
#define DBG_LED_WAN(x)  rtl819x_gpio_pin_set_val(BSP_GPIO_PIN_C7,(x)?1:0)
#define DBG_LED_SYS(x)  rtl819x_gpio_pin_set_val(BSP_GPIO_PIN_H1,(x)?0:1)
//vlad

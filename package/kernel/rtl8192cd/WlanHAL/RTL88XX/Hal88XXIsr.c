...
)
{
	...
	if( pHalData->IntArray[0] & BIT_VIDOK ) result |= HAL_INT_FLAG_VIDOK;
	if( pHalData->IntArray[0] & BIT_VODOK ) result |= HAL_INT_FLAG_VODOK;
	if( pHalData->IntArray[0] & BIT_BEDOK ) result |= HAL_INT_FLAG_BEDOK;
	if( pHalData->IntArray[0] & BIT_BKDOK ) result |= HAL_INT_FLAG_BKDOK;

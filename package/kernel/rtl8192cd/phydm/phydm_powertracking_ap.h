...
typedef struct ODM_RF_Calibration_Structure
{
	...
	u1Byte 	bDPPathAOK;
	u1Byte 	bDPPathBOK;
	u1Byte 	DPPathAResult[3];
	u1Byte 	DPPathBResult[3];
	u1Byte	bDPKEnable;
	u4Byte	Txrate[11];
	u1Byte 	pwsf_2g_a[3];

	u1Byte 	pwsf_2g_b[3];
	u4Byte	lut_2g_even_a[3][64];
	u4Byte	lut_2g_odd_a[3][64];
	u4Byte	lut_2g_even_b[3][64];
	u4Byte	lut_2g_odd_b[3][64];
	u1Byte	ThermalValue_DPK;
	u1Byte	ThermalValue_DPK_AVG[AVG_THERMAL_NUM_DPK];
	u1Byte	ThermalValue_DPK_AVG_index;

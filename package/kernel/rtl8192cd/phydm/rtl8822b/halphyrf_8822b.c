...
{
	u4Byte LC_Cal = 0, cnt = 0, tmp0xc00, tmp0xe00, tmprf0xc4;

	tmp0xc00 = ODM_GetBBReg(pDM_Odm, 0xc00, 0xffffffff);
	tmp0xe00 = ODM_GetBBReg(pDM_Odm, 0xe00, 0xffffffff);
	tmprf0xc4 = ODM_GetRFReg(pDM_Odm, ODM_RF_PATH_A, 0xc4, bRFRegOffsetMask);

	ODM_SetBBReg(pDM_Odm, 0xc00, 0xffffffff, 0x4);
	ODM_SetBBReg(pDM_Odm, 0xe00, 0xffffffff, 0x4);
	ODM_SetRFReg(pDM_Odm, ODM_RF_PATH_A, 0x0, 0xfffff, 0x10000);
	ODM_SetRFReg(pDM_Odm, ODM_RF_PATH_B, 0x0, 0xfffff, 0x10000);
	/*backup RF0x18*/
	LC_Cal = ODM_GetRFReg(pDM_Odm, ODM_RF_PATH_A, RF_CHNLBW, bRFRegOffsetMask);
	/*disable RTK*/
	ODM_SetRFReg(pDM_Odm, ODM_RF_PATH_A, 0xc4, bRFRegOffsetMask, 0x01402);
	/*Start LCK*/
	...
	/**restore*/
	ODM_SetRFReg(pDM_Odm, ODM_RF_PATH_A, 0xc4, bRFRegOffsetMask, tmprf0xc4);
	ODM_SetBBReg(pDM_Odm, 0xc00, 0xffffffff, tmp0xc00);
	ODM_SetBBReg(pDM_Odm, 0xe00, 0xffffffff, tmp0xe00);
	ODM_SetRFReg(pDM_Odm, ODM_RF_PATH_A, 0x0, bRFRegOffsetMask, 0x3ffff);
	ODM_SetRFReg(pDM_Odm, ODM_RF_PATH_B, 0x0, bRFRegOffsetMask, 0x3ffff);
	ODM_RT_TRACE(pDM_Odm, ODM_COMP_CALIBRATION, ODM_DBG_LOUD, ("[LCK]LCK end!!!!!!!\n"));
}
